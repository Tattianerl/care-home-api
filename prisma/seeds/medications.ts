    ...
    data: [
      {
        ...
        controlado: false,
        usoContinuo: true,
        observacoes: "Administrar após café da manhã e jantar.",
        patientId: "22222222-2222-4222-8222-222222222001",
        userId: "11111111-1111-4111-8111-111111111003",
        prescritoPorId: "11111111-1111-4111-8111-111111111003",
      ...
      },
      {
        ...
        controlado: false,
        usoContinuo: true,
        observacoes: "Administrar junto às refeições.",
        patientId: "22222222-2222-4222-8222-222222222001",
        userId: "11111111-1111-4111-8111-111111111003",
        prescritoPorId: "11111111-1111-4111-8111-111111111003",
      ...
      },
      {
        ...
        controlado: false,
        usoContinuo: true,
        observacoes: "Administrar à noite.",
      ...
      },
      {
        ...
        controlado: false,
        usoContinuo: true,
        observacoes: "Administrar após almoço.",
      ...
      },
      {
        ...
        controlado: false,
        usoContinuo: false,
        observacoes: "Administrar apenas quando houver edema importante.",
      ...
      },
      {
        ...
        controlado: false,
        usoContinuo: true,
        observacoes: "Paciente com Parkinson.",
        patientId: "22222222-2222-4222-8222-222222222004",
        userId: "11111111-1111-4111-8111-111111111003",
        prescritoPorId: "11111111-1111-4111-8111-111111111003",
